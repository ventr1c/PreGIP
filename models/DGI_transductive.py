...
class DGI(torch.nn.Module):
    ...
    def test_old(self,x, edge_index, edge_weight, y):
        return test(self.encoder_model,x, edge_index, edge_weight, y)
    

    def test(self, features, edge_index, edge_weight, labels, idx_train, idx_test, idx_val):
        ...
        result = LREvaluator()(output, labels, split)
