...
for seed in range(10,15):
    ...
    torch.save(gcl.encoder.state_dict(), "./checkpoint/{}_GCL/gcl_{}.pt".format('ZINC200k', seed))

    # gcl.encoder.load_state_dict(torch.load("./checkpoint/{}_GCL/gcl_{}.pt".format('ZINC200k', seed)))
...
# nohup python -u transfer_pretrain_masking.py > ./logs/transfer_pretrain_masking.log 2>&1 &
# nohup python -u transfer_pretrain_GCL.py > ./logs/transfer_pretrain_GCL.log 2>&1 &