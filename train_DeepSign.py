...
for idx in idx_pair:
    key_watermark.append(dataset[idx])
...
for seed in range(10,10+args.num_repeat):
    ...
    acc_fix, IP_fix = gcl.test(trainloader,testloader, key_watermark,args)
    acc_finetune, IP_finetune = gcl.test_finetune(trainloader,testloader, key_watermark,args)
    ...
    acc_finetune, IP_finetune = ind_gcl.test_finetune(trainloader,testloader, key_watermark,args)
