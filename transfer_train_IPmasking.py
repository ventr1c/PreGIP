...
if(args.if_load_watermark):
    ...
    gcl.encoder.load_state_dict(torch.load("./checkpoint/{}_Masking/wm_mask_{}_{}_{}.pt".format('ZINC200k',args.step, args.alpha, args.watermark_size)))
else:
    ...
    torch.save(gcl.encoder.state_dict(), "./checkpoint/{}_Masking/wm_mask_{}_{}_{}.pt".format('ZINC200k',args.step, args.alpha, args.watermark_size))
