...
if(args.if_load_watermark):
    ...
    gcl.encoder.load_state_dict(torch.load("./checkpoint/{}_GCL/CertWM_wm_gcl_{}_{}_{}.pt".format('ZINC200k',args.alpha, args.watermark_size, args.random)))
else:
<<<<<<< HEAD
    gcl.watermarking(key_normal, key_watermark, pretrain_dataloader, args, verbose=args.debug)
=======
...
>>>>>>> b99538ad237ca2f0286619ea31de9e82c9204f15
    torch.save(gcl.encoder.state_dict(), "./checkpoint/{}_GCL/CertWM_wm_gcl_{}_{}_{}.pt".format('ZINC200k',args.alpha, args.watermark_size, args.random))
#%%
acc_fix_list = []
acc_finetune_list = []
...
>>>>>>> b99538ad237ca2f0286619ea31de9e82c9204f15
    ...
    ind_gcl.encoder.load_state_dict(torch.load("./checkpoint/{}_GCL/gcl_{}.pt".format('ZINC200k', seed)))
